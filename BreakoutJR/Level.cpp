...
void Level::CreateLvlTwo() {
	...
	Rect m_left_wall = Rect(HORIZONTAL_MARGIN, VERTICLE_MARGIN * 2, WALL_THICKNESS, COURT_HEIGHT - VERTICLE_MARGIN);
	Rect m_right_wall = Rect(HORIZONTAL_MARGIN + COURT_WIDTH, VERTICLE_MARGIN * 2, WALL_THICKNESS, COURT_HEIGHT - VERTICLE_MARGIN);
